    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1), angle, glm::vec3(0.0, 1.0, 0.0)) * glm::vec4(forward, 1)));
            right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1), angle, glm::vec3(0.0, 1.0, 0.0)) * glm::vec4(right, 1)));
            up = glm::normalize(glm::cross(right, forward));
        }
