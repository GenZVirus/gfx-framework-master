...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0.2, 0.8, 0.6)), // 0
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3( 1, -1,  1), glm::vec3(0.2, 0.6, 0.8)), // 1
            VertexFormat(glm::vec3(-1,  1,  1), glm::vec3(0.8, 0.2, 0.6)), // 2
            VertexFormat(glm::vec3( 1,  1,  1), glm::vec3(0.8, 0.6, 0.2)), // 3
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(0.2, 0.8, 0.6)), // 4
            VertexFormat(glm::vec3( 1, -1, -1), glm::vec3(0.5, 0.1, 0.7)), // 5
            VertexFormat(glm::vec3(-1,  1, -1), glm::vec3(0.7, 0.7, 0.1)), // 6
            VertexFormat(glm::vec3( 1,  1, -1), glm::vec3(0.2, 0.2, 0.9))  // 7
        ...
        {
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(0.2, 0.8, 0.6)), // 0
            VertexFormat(glm::vec3( 0, -1,  1), glm::vec3(0.8, 0.2, 0.3)), // 1
            VertexFormat(glm::vec3( 1, -1,  0), glm::vec3(0.6, 0.2, 0.8)), // 2
            VertexFormat(glm::vec3( 0,  1,  0), glm::vec3(0.8, 0.2, 0.7))  // 3
        };
        ...
        {
            VertexFormat(glm::vec3(-1, -1,  0), glm::vec3(0.2, 0.8, 0.6)), // 0
            VertexFormat(glm::vec3(-1,  1,  0), glm::vec3(0.8, 0.2, 0.3)), // 1
            VertexFormat(glm::vec3( 1,  1,  0), glm::vec3(0.6, 0.2, 0.8)), // 2
            VertexFormat(glm::vec3( 1, -1,  0), glm::vec3(0.8, 0.2, 0.7))  // 3
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0.5f), glm::vec3(0.5f));

    // TODO(student): Draw the tetrahedron

    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(-0.5f, 0.5f, 0.5f), glm::vec3(0.5f));

    // TODO(student): Draw the square

    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0.0f, 1.5f, 0.5f), glm::vec3(0.5f));
