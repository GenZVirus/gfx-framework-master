...
class ParticleEffect
{
 public:
    ...
    virtual void Render(implemented::MyCamera *camera, Shader *shader, unsigned int nrParticles = -1);
...
template <class T>
void ParticleEffect<T>::Render(implemented::MyCamera*camera, Shader *shader, unsigned int nrParticles)
{
    // Bind MVP
    ...
    glUniform3fv(shader->loc_eye_pos, 1, glm::value_ptr(camera->position));
